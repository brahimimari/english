                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-about mt-40">
                            ...
                            <p>FLUENT ENGLISH ACADEMY est un centre d’enseignement de la langue anglaise visant l’excellence.</p>
                            <ul class="mt-20">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="copyright text-md-left text-center pt-15">
                            <p><a target="_blank" href="#">Fluent English Academy</a> </p>
                        </div>
                    </div>
                    <div class="col-md-4">
